...
def main():
    ...
    data, intensity, data_num = data_utils.load_data(args.filelist)

    intensity = np.reshape(intensity, [data.shape[0], data.shape[1], 1])
    ...
    with tf.Session() as sess:
        ...
        for batch_idx in range(batch_num):
            ...
            intensity_batch = intensity[[batch_idx] * batch_size, ...]
