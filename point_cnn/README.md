# PointCNN on DataFountain
## Get start
Install requirements:
```
pip install -r requirements.txt
```
Compile FPS before the training/evaluation:
```
cd sampling
bash tf_sampling_compile.sh
```
Test seg:<br>
```path_to_test_set```is the path of test set dir which include pts\intensity.
```
python3 test_df_seg_processes_fru.py -i path_to_test_set \
-o path_to_output_test_results \
-l ./model/iter-final \
-m pointcnn_seg -x df_x4_2048_fps -g 0
```
